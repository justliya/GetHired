...
def analyze_webpage_and_determine_action(
    ...
    2. If source code appears to be incomplete, complete it to make it valid html. Keep the job titles as is. Only complete missing html syntax
...
company_research_agent = Agent(
    ...
    description="Peform extensive research on job postings and collect information that helps user make an informed decision before applyingc",

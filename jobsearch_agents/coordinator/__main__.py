...
def parse_args():
    ...
    parser.add_argument(
        "--timeout",
        type=float,
        default=float(os.getenv("TIMEOUT", default_timeout)),
...
async def main():
    ...
    logger.info("Starting Coordinator Agent A2A Server initialization...")
    ...
    try:
        ...
        async with exit_stack:
            ...
            logger.info(f"Coordinator Agent A2A server starting on {host}:{port}")
